      ...
      <div className="pt-6 pb-4 space-y-3">
        ...
        >
          <div className="flex flex-col">
            {/* Top line: "Kaargar in" — the "in" sits on the same baseline
                as the wordmark, reading as one phrase. */}
            <div className="flex items-baseline gap-1.5">
              <span
                style={{ fontFamily: '"Playwrite NO", cursive', fontSize: '22px', fontWeight: 400, color: 'var(--text-primary)', lineHeight: 1.2 }}
              >
                Kaargar
              </span>
              <span className="text-sm font-medium" style={{ color: 'var(--text-primary)' }}>in</span>
            </div>

            {/* Bottom line: the big "30 min" promise — not a live per-job
                estimate (that's on the tracking screen, computed from the
                actual worker/customer distance); this is a static brand
                number. */}
            <div className="flex items-baseline gap-1">
              <span className="text-4xl mt-1 font-bold leading-none italic" style={{ color: 'var(--text-primary)' }}>30</span>
              <span className="text-[10px] font-medium leading-none italic" style={{ color: 'var(--text-primary)' }}>min</span>
            </div>
          </div>
        </motion.div>
