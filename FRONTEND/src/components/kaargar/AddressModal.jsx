    ...
    <GlassModal open={open} onClose={onClose} title="Choose Location" size="md">
      <div className="space-y-5">
        ...
        <div
          ...
          style={{ background: 'rgba(75,123,255,0.1)', border: '1px solid rgba(75,123,255,0.25)' }}
        >
              ...
              {savedAddresses.map((addr) => {
                ...
                return (
                  <motion.div
                    ...
                    style={active
                      ? { background: 'rgba(75,123,255,0.15)', borderColor: 'rgba(75,123,255,0.3)' }
            ...
            {filteredAreas.map((area) => {
              ...
              return (
                <motion.button
                  ...
                  style={active
                    ? { background: 'rgba(75,123,255,0.2)', borderColor: 'rgba(75,123,255,0.35)', color: 'var(--brand)' }
